...
export const TxtToolbar: React.FC<TxtToolbarProps> = ({
  ...
  return (
    <div
      ref={toolbarRef}
      className="sticky top-[104px] z-40 bg-background border-b border-border"
    >
        ...
        <div className="flex items-center justify-between py-4 gap-6">
          ...
          <div className="relative flex-1 max-w-lg group">
            <div className="absolute left-0 top-1/2 -translate-y-1/2 flex items-center gap-2">
              <Search className={cn(
                ...
                searchFocused ? "text-[#00ff88]" : "text-muted-foreground"
              )} />
            ...
            {searchQuery && (
              <button
                ...
                className="absolute right-0 top-1/2 -translate-y-1/2 p-1 text-muted-foreground hover:text-[#00ff88] transition-colors"
              >
                <X className="w-4 h-4" />
              </button>
            )}
          ...
          <div className="flex items-center gap-4">
            ...
            <button
              ...
              className="flex items-center gap-2 px-3 py-2 text-xs font-mono text-muted-foreground hover:text-[#00ff88] hover:bg-[#00ff88]/10 transition-all disabled:opacity-30 disabled:pointer-events-none border border-transparent hover:border-[#00ff88]/30"
            >
